...
import { ShoppingBag, LayoutDashboard, DollarSign, Plus, Edit2, Trash2, X, Upload, Loader2 } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { API_URL } from '../../context/AuthContext';

const categories = ['Rings', 'Necklaces', 'Earrings', 'Bracelets', 'Hair Clips', 'Bags', 'Keychains'];
